...
class Color
{
    ...
    /**
     * Returns a single color value based on the given Palette and ShadeIndex.
     *
     ...
     * @throws Exception
     */
    public static function getColorPalette(string $palette = 'red'): array
    {
        return self::COLORS[$palette] ?? throw new Exception('Given Palette not found!');
    }

    /**
     * Returns an array multiple colors, all in the same shade
